...
public class RcvProduitMain extends RecyclerView.Adapter<RcvProduitMain.ViewHolder> {
    Context context;
    List<Produit> listP;

    public RcvProduitMain(Context context, List<Produit> listP) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.produititemmain, parent, false);
